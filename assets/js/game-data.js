...
const baseTiles = [
  ...
  { name: "知識挑戰", type: "physics", machineType: "wheel", icon: "fa-book", pos: [0, 6] },
  ...
  { name: "學費稅", type: "tax", icon: "fa-receipt", pos: [4, 6] },
  ...
  { name: "知識挑戰", type: "physics", machineType: "pulley", icon: "fa-book", pos: [4, 0] },
  ...
  { name: "知識挑戰", type: "physics", machineType: "gear", icon: "fa-book", pos: [1, 0] },
